...
from misc.data_loader import BertBatchDataLoader
...
if __name__ == "__main__":
    ...
    dset_train = BertBatchDataLoader(fpath = args.fp_train, embd_dict = pre_embd, concept_dict=concept_dict,
                                 split='train', emd_dim=args.fp_word_embd_dim, num_concepts = args.num_concepts)

    dset_val   = BertBatchDataLoader(fpath = args.fp_val, embd_dict = pre_embd, concept_dict=concept_dict,
    ...
    if args.model_name.lower() == 'bertse':
        import models.BERTmodel as net
        model = net.BERTse(hidden_size = args.hidden_size,
